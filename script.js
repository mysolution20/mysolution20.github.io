$(document).ready(function() {
 const apiRoot = 'http://hidden-mesa-03483.herokuapp.com/v1/task/';
 const trelloApiRoot = 'http://hidden-mesa-03483.herokuapp.com/v1/trello/';
...
prepareBoardOrListSelectOptions(boards);
 ...
 parentEl.attr('data-task-id', data.id).toggleClass('datatable__row--
editing');
...
prepareBoardOrListSelectOptions(availableBoards[selectedBoardId].lists);
 ...
 $tasksContainer.on('click','[data-trello-card-creation-trigger]',
